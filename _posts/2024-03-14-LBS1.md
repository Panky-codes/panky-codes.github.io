...
It is important to define what a Large Block Size(LBS) is before writing
multipart articles about it. In the context of Linux, LBS is defined as
...
**filesystem block size**(FSB) of a filesystem.
...
can never be greater than 4k bytes in an x86_64 system. Is that a problem
...
In summary:
- Historically, page cache was closely tied to PAGE.
