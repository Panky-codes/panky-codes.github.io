...
Large block sizes(LBS) on Linux.
...
If you only care about the final attempt that made it upstream, then please
refer to the next [part](https://blog.pankajraghav.com/2024/09/05/LBS3.html).

This post will require some level of the Linux kernel internals
understanding.
Before reading this article, I would highly recommend
checking out [Part1](https://blog.pankajraghav.com/2024/03/14/LBS1.html)
...
Even though this patchset did not upstream LBS support, lots of the
XFS bugs to support this feature were fixed as a part of this series. This
made things easy later to support LBS in XFS.
